        ...
        <div class=" col-md-10">
          ...
          <div class="col-md-4 mt-3 ml-5">
            <div class="card shadow " style="width: 18rem; box-shadow: 1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px; cursor:pointer;">
              ...
              <img class="myimg" src="../uploadimg/stack-of-books.png" alt="Card" width="288" height="200">
              <div class="card-body">
                <p class="card-text"><a href="manage_courses/manage_courses.php" style="text-decoration: none;">MANAGE YOUR LESSONS <i class="fa fa-book ml-3"></i></a></p>
              </div>
            </div>
