...
.tab-card-header > .tab-content {
 ...
 <!-- ========================================================================================================================== -->
  ...
  <a class="navbar-brand text-white" href="#">LearnIt</a>
...
<!-- sidebar starts -->
        ...
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
            ...
            <li class="list-group-item bg-dark"><a href="/uniquedeveloper/uniquedeveloper/admin/manage_quiz/manage_quiz.php">Manage Quizes</a></li>
...
<div class="card-header mt-3 mr-5 bg-white text-info border-0 shadow card1" style="width: 1050px; box-shadow: 1px 1px 1px 1px #ccc"><b>YOUR LESSONS</b></div><br>
<div class="row">
        ...
        <div class="tab-content" id="myTabContent">   <!-- tab content starts -->
          ...
          <div class="tab-pane fade show active p-3" id="one" role="tabpanel" aria-labelledby="one-tab">
            ...
            <div class="card-body col-md-12">
				  ...
				  <div class="card-header bg-danger text-light p-2 cardh2"><h3>ADD NEW VIDEO LESSON</h3></div>
				  ...
				  <form action="video_add.php" method="post" enctype="multipart/form-data" onsubmit="return validation()">
					    <div class="form-group">
					      ...
					      <input type="text" class="form-control" id="c_name" placeholder="Enter Lesson Name" name="course_name">
					      <span id="name_error" class="text-danger font-weight-bold"></span>
					    </div>
					    <div class="form-group">
					      <label for="pwd">Lesson Description</label>
					      <input type="text" class="form-control" id="c_desc" placeholder="Enter Lesson Description" name="course_desc">
					      <span id="desc_error" class="text-danger font-weight-bold"></span>
					    </div>

					     <div class="form-group">
					      <label for="pwd">Lesson Video</label>
					      <input type="text" class="form-control" id="c_img" placeholder="Enter Lesson Video Link" name="course_image">
          ...
          <div class="tab-pane fade p-3" id="two" role="tabpanel" aria-labelledby="two-tab">
            ...
            <div class="card-body col-md-12">
            		...
            		<div class="card" style="box-shadow: 2px 2px 2px 2px #dfdfdf;">
				  <div class="card-header bg-primary text-light p-2 cardh2 "><h3>UPDATE VIDEO LESSON</h3></div>
				 ...
				 <form action="video_add.php" method="post" enctype="multipart/form-data" onsubmit="">
				 	 ...
				 	 <div class="form-group">
					    ...
					    <label for="exampleFormControlSelect1">Select video Lesson Name :</label>
          ...
          <div class="tab-pane fade p-3" id="three" role="tabpanel" aria-labelledby="three-tab">
            ...
            <div class="card-body col-md-12">
            		...
            		<div class="card" style="box-shadow: 2px 2px 2px 2px #dfdfdf;">
				  <div class="card-header bg-primary text-light p-2 cardh2"><h3>DELETE VIDEO LESSON</h3></div>
